...
public class GravitationStrikeParticleOptions implements ParticleOptions {
    ...
    public GravitationStrikeParticleOptions(float xf, float yf, float zf, float xu, float yu, float zu, float scale) {
        this.scale = scale;
        this.xf = xf;
        this.yf = yf;
        this.zf = zf;
    ...
    public static final StreamCodec<ByteBuf, GravitationStrikeParticleOptions> STREAM_CODEC = StreamCodec.of(
            (buf, option) -> {
            ...
            buf -> new GravitationStrikeParticleOptions(
                    buf.readFloat(), buf.readFloat(), buf.readFloat(),
                    buf.readFloat(), buf.readFloat(), buf.readFloat(),
                    buf.readFloat())
    );

    public static final MapCodec<GravitationStrikeParticleOptions> MAP_CODEC = RecordCodecBuilder.mapCodec(object ->
            object.group(
            ...
            ).apply(object, GravitationStrikeParticleOptions::new)
    );

    @Override
    public @NotNull ParticleType<?> getType() {
        return ModParticles.GRAVITATION_STRIKE_SLASH.get();
    }
}
